describe("Open account create page", function () {
    this.timeout(15000);
    describe("should open customer account create page", function() {
        it("and should create B2C customer account successfully", function () {
    ...
    describe("should open wholesale account create page", function() {
